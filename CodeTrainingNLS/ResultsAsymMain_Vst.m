...
%% Entire data set
input = 'Vst'; specs = 'p1'; noWvn = 1; disp('CNLS Vst p=1')
bl_St = [0;-10;-10;-10]; bu_St = [10;10;10;10]; Rbound = [0 Inf];
...
[models, MSE_TestWRF] = ResultsTrainTest(models, b_l, b_u, noWvn, opt, Rbound);

%%
save([path, 'Results/ResultsVst/Results_' opt '_' input '_' specs '.mat'], 'models', 'MSE_TestWRF');
...
for i = 1:nBounds
    ...
    bl_St = [0;-10;-10;-10]; bu_St = [10;10;10;10]; Rbound = Rbounds(i,:);
    x0 = repmat([4.56; 0.07; 9.85*(pi/180); 4.52*(pi/180); 3.37; 0.13; -11.78*(pi/180); ...
    -4.34*(pi/180)],[1,5]);
    b_l=[bl_St; zeros(4,1)]; b_u=[bu_St; zeros(4,1)];

    [models, SSE_TestHWind, SSE_TestWRF] = ResultsTrainTest(x0, b_l, b_u, noWvn, opt, Rbound);
    save([path, 'Results/ResultsVst/Results_' opt '_' input '_' specs '.mat'],'models', 'SSE_TestHWind', 'SSE_TestWRF');
end
...
save([path, 'Results/ResultsVst/Results_' stormName '_' opt '_' input '_' specs '.mat'], 'x', 'ci', 'MSE');
